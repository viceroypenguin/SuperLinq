...
{
	/// <summary>
	///	    Creates a <see cref="Dictionary{TKey,TValue}" /> from a sequence of <see cref="KeyValuePair{TKey,TValue}" />
	///     elements.
	/// </summary>
	/// <typeparam name="TKey">
	///	    The type of the key.
	...
	/// </param>
	/// <returns>
	///	    A <see cref="Dictionary{TKey, TValue}"/> containing the values mapped to their keys.
	/// </returns>
	...
	/// <summary>
	///	    Creates a <see cref="Dictionary{TKey,TValue}" /> from a sequence of tuples of 2 where the first item is the
