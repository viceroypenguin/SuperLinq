...
public static partial class SuperEnumerable
{
	...
	/// </para>
	/// </remarks>
	public static IEnumerable<(TLeft Left, TRight Right)> InnerHashJoin<TLeft, TRight, TKey>(
	...
	/// </para>
	/// </remarks>
	public static IEnumerable<TResult> InnerHashJoin<TLeft, TRight, TKey, TResult>(
		this IEnumerable<TLeft> left,
		IEnumerable<TRight> right,
		Func<TLeft, TKey> leftKeySelector,
		Func<TRight, TKey> rightKeySelector,
	...
	/// </para>
	/// </remarks>
	public static IEnumerable<(TLeft Left, TRight? Right)> LeftOuterHashJoin<TLeft, TRight, TKey>(
		this IEnumerable<TLeft> left,
		IEnumerable<TRight> right,
		Func<TLeft, TKey> leftKeySelector,
		Func<TRight, TKey> rightKeySelector,
	...
	/// </para>
	/// </remarks>
	public static IEnumerable<TResult> LeftOuterHashJoin<TLeft, TRight, TKey, TResult>(
		this IEnumerable<TLeft> left,
		IEnumerable<TRight> right,
		Func<TLeft, TKey> leftKeySelector,
		Func<TRight, TKey> rightKeySelector,
	...
	/// </para>
	/// </remarks>
	public static IEnumerable<(TLeft? Left, TRight Right)> RightOuterHashJoin<TLeft, TRight, TKey>(
		this IEnumerable<TLeft> left,
		IEnumerable<TRight> right,
		Func<TLeft, TKey> leftKeySelector,
		Func<TRight, TKey> rightKeySelector,
	...
	/// </para>
	/// </remarks>
	public static IEnumerable<TResult> RightOuterHashJoin<TLeft, TRight, TKey, TResult>(
		this IEnumerable<TLeft> left,
		IEnumerable<TRight> right,
		Func<TLeft, TKey> leftKeySelector,
		Func<TRight, TKey> rightKeySelector,
	...
	/// </para>
	/// </remarks>
	public static IEnumerable<(TLeft? Left, TRight? Right)> FullOuterHashJoin<TLeft, TRight, TKey>(
		this IEnumerable<TLeft> left,
		IEnumerable<TRight> right,
		Func<TLeft, TKey> leftKeySelector,
		Func<TRight, TKey> rightKeySelector,
	...
	/// </para>
	/// </remarks>
	public static IEnumerable<TResult> FullOuterHashJoin<TLeft, TRight, TKey, TResult>(
		this IEnumerable<TLeft> left,
		IEnumerable<TRight> right,
		Func<TLeft, TKey> leftKeySelector,
		Func<TRight, TKey> rightKeySelector,
	...
	private static IEnumerable<TResult> JoinHash<TLeft, TRight, TKey, TResult>(
