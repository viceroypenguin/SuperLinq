...
{
	/// <summary>
	///	    Creates a custom <see cref="IEqualityComparer{T}"/> for a <see cref="KeyValuePair{TKey, TValue}"/> based on
	///     custom comparers for each component.
	/// </summary>
	/// <typeparam name="TKey">
	///	    The type of the first element of the <see cref="KeyValuePair{TKey, TValue}"/>
	/// </typeparam>
	/// <typeparam name="TValue">
	///	    The type of the second element of the <see cref="KeyValuePair{TKey, TValue}"/>
	/// </typeparam>
	/// <param name="keyComparer">
	///	    The custom comparer for <typeparamref name="TKey"/>. If <see langword="null"/>, then <see
	///     cref="EqualityComparer{T}.Default" /> will be used.
	/// </param>
	/// <param name="valueComparer">
	///	    The custom comparer for <typeparamref name="TValue"/>. If <see langword="null"/>, then <see
	///     cref="EqualityComparer{T}.Default" /> will be used.
	/// </param>
	/// <returns>
	///	    An <see cref="IEqualityComparer{T}"/> that can be used to compare two <see cref="KeyValuePair{TKey,
	///     TValue}"/> using the provided comparers for each component.
	/// </returns>
