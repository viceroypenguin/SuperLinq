...
public static partial class SuperEnumerable
{
	...
	/// elements in the <see cref="IEnumerable{T}"/> that extends backwards from the specified index to the first
	/// element.
	/// </summary>
	/// <typeparam name="TSource">
	/// The type of elements of <paramref name="source"/></typeparam>
	...
	/// <see cref="IEnumerable{T}"/> that extends backwards from <paramref name="index"/> to the first element, if
	...
	/// <summary>
	/// Searches for the specified object and returns the zero-based index of the last occurrence within the range of
	/// elements in the <see cref="IEnumerable{T}"/> that ends at the specified index to the last element and contains
	...
	/// <returns>
	/// The zero-based index of the last occurrence of <paramref name="item"/> within the the range of elements in the
	/// <see cref="IEnumerable{T}"/> that that ends at <paramref name="index"/> and contains <paramref name="count"/>
