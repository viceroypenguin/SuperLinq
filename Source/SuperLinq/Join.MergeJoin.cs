...
public static partial class SuperEnumerable
{
	...
	/// </para>
	/// </remarks>
	public static IEnumerable<(TLeft Left, TRight Right)> InnerMergeJoin<TLeft, TRight, TKey>(
	...
	/// </para>
	/// </remarks>
	public static IEnumerable<TResult> InnerMergeJoin<TLeft, TRight, TKey, TResult>(
		this IEnumerable<TLeft> left,
		IEnumerable<TRight> right,
		Func<TLeft, TKey> leftKeySelector,
		Func<TRight, TKey> rightKeySelector,
	...
	/// </para>
	/// </remarks>
	public static IEnumerable<(TLeft Left, TRight? Right)> LeftOuterMergeJoin<TLeft, TRight, TKey>(
		this IEnumerable<TLeft> left,
		IEnumerable<TRight> right,
		Func<TLeft, TKey> leftKeySelector,
		Func<TRight, TKey> rightKeySelector,
	...
	/// </para>
	/// </remarks>
	public static IEnumerable<TResult> LeftOuterMergeJoin<TLeft, TRight, TKey, TResult>(
		this IEnumerable<TLeft> left,
		IEnumerable<TRight> right,
		Func<TLeft, TKey> leftKeySelector,
		Func<TRight, TKey> rightKeySelector,
	...
	/// </para>
	/// </remarks>
	public static IEnumerable<(TLeft? Left, TRight Right)> RightOuterMergeJoin<TLeft, TRight, TKey>(
		this IEnumerable<TLeft> left,
		IEnumerable<TRight> right,
		Func<TLeft, TKey> leftKeySelector,
		Func<TRight, TKey> rightKeySelector,
	...
	/// </para>
	/// </remarks>
	public static IEnumerable<TResult> RightOuterMergeJoin<TLeft, TRight, TKey, TResult>(
		this IEnumerable<TLeft> left,
		IEnumerable<TRight> right,
		Func<TLeft, TKey> leftKeySelector,
		Func<TRight, TKey> rightKeySelector,
	...
	/// </para>
	/// </remarks>
	public static IEnumerable<(TLeft? Left, TRight? Right)> FullOuterMergeJoin<TLeft, TRight, TKey>(
		this IEnumerable<TLeft> left,
		IEnumerable<TRight> right,
		Func<TLeft, TKey> leftKeySelector,
		Func<TRight, TKey> rightKeySelector,
	...
	/// </para>
	/// </remarks>
	public static IEnumerable<TResult> FullOuterMergeJoin<TLeft, TRight, TKey, TResult>(
		this IEnumerable<TLeft> left,
		IEnumerable<TRight> right,
		Func<TLeft, TKey> leftKeySelector,
		Func<TRight, TKey> rightKeySelector,
	...
	private static IEnumerable<TResult> JoinMerge<TLeft, TRight, TKey, TResult>(
