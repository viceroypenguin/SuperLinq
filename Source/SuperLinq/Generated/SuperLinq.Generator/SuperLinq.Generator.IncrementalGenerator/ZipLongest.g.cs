...
public static partial class SuperEnumerable
{
	...
	/// </param>
	public static global::System.Collections.Generic.IEnumerable<TResult> ZipLongest<T1, T2, TResult>(this 
	...
	)
	{
		...
		if (
			first is global::System.Collections.Generic.IList<T1> list1&&
			second is global::System.Collections.Generic.IList<T2> list2)
		{
			return new ZipLongestIterator<T1, T2, TResult>(
				list1,
				list2,
				resultSelector
			);
		...
		)
		{
			...
			while (
				(f1 = DoRead(f1, e1, out var v1))
				| (f2 = DoRead(f2, e2, out var v2))
			)
			{
	...
	public static global::System.Collections.Generic.IEnumerable<(T1?,T2?)> 
		ZipLongest<T1,T2>(this
			global::System.Collections.Generic.IEnumerable<T1> first,
			global::System.Collections.Generic.IEnumerable<T2> second
	) => ZipLongest(first, second, global::System.ValueTuple.Create);
	...
	private sealed class ZipLongestIterator<T1, T2, TResult> : ListIterator<TResult>
	{
		...
		protected override IEnumerable<TResult> GetEnumerable()
		{
			...
			for (var i = 0; i < cnt; i++)
			{
				yield return _resultSelector(
					i < _list1.Count ? _list1[i] : default, 
					i < _list2.Count ? _list2[i] : default
				);
			}
		}
		...
		protected override TResult ElementAt(int index)
		{
			...
			return _resultSelector(
				index < _list1.Count ? _list1[index] : default, 
				index < _list2.Count ? _list2[index] : default
			);
		}
	}
	...
	/// </param>
	public static global::System.Collections.Generic.IEnumerable<TResult> ZipLongest<T1, T2, T3, TResult>(this 
		global::System.Collections.Generic.IEnumerable<T1> first,
		global::System.Collections.Generic.IEnumerable<T2> second,
	...
	)
	{
		...
		if (
			first is global::System.Collections.Generic.IList<T1> list1&&
			second is global::System.Collections.Generic.IList<T2> list2&&
			third is global::System.Collections.Generic.IList<T3> list3)
		{
			return new ZipLongestIterator<T1, T2, T3, TResult>(
				list1,
				list2,
				list3,
				resultSelector
	...
	public static global::System.Collections.Generic.IEnumerable<(T1?,T2?,T3?)> 
		ZipLongest<T1,T2,T3>(this
			global::System.Collections.Generic.IEnumerable<T1> first,
			global::System.Collections.Generic.IEnumerable<T2> second,
			global::System.Collections.Generic.IEnumerable<T3> third
	) => ZipLongest(first, second, third, global::System.ValueTuple.Create);
	...
	private sealed class ZipLongestIterator<T1, T2, T3, TResult> : ListIterator<TResult>
	{
		...
		protected override IEnumerable<TResult> GetEnumerable()
		{
			...
			for (var i = 0; i < cnt; i++)
			{
				yield return _resultSelector(
					i < _list1.Count ? _list1[i] : default, 
					i < _list2.Count ? _list2[i] : default, 
					i < _list3.Count ? _list3[i] : default
				);
			}
		}
		...
		protected override TResult ElementAt(int index)
		{
			...
			return _resultSelector(
				index < _list1.Count ? _list1[index] : default, 
				index < _list2.Count ? _list2[index] : default, 
				index < _list3.Count ? _list3[index] : default
			);
		}
	}
	...
	/// </param>
	public static global::System.Collections.Generic.IEnumerable<TResult> ZipLongest<T1, T2, T3, T4, TResult>(this 
		global::System.Collections.Generic.IEnumerable<T1> first,
		global::System.Collections.Generic.IEnumerable<T2> second,
		global::System.Collections.Generic.IEnumerable<T3> third,
	...
	)
	{
		...
		if (
			...
			second is global::System.Collections.Generic.IList<T2> list2&&
			third is global::System.Collections.Generic.IList<T3> list3&&
			fourth is global::System.Collections.Generic.IList<T4> list4)
		{
			return new ZipLongestIterator<T1, T2, T3, T4, TResult>(
				list1,
				list2,
				list3,
				list4,
	...
	public static global::System.Collections.Generic.IEnumerable<(T1?,T2?,T3?,T4?)> 
		ZipLongest<T1,T2,T3,T4>(this
			global::System.Collections.Generic.IEnumerable<T1> first,
			global::System.Collections.Generic.IEnumerable<T2> second,
			global::System.Collections.Generic.IEnumerable<T3> third,
			global::System.Collections.Generic.IEnumerable<T4> fourth
	) => ZipLongest(first, second, third, fourth, global::System.ValueTuple.Create);
	...
	private sealed class ZipLongestIterator<T1, T2, T3, T4, TResult> : ListIterator<TResult>
	{
		...
		protected override IEnumerable<TResult> GetEnumerable()
		{
			...
			for (var i = 0; i < cnt; i++)
			{
				yield return _resultSelector(
					...
					i < _list2.Count ? _list2[i] : default, 
					i < _list3.Count ? _list3[i] : default, 
					i < _list4.Count ? _list4[i] : default
				);
			}
		}
		...
		protected override TResult ElementAt(int index)
		{
			...
			return _resultSelector(
				...
				index < _list2.Count ? _list2[index] : default, 
				index < _list3.Count ? _list3[index] : default, 
				index < _list4.Count ? _list4[index] : default
			);
		}
	}
