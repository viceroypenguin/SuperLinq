...
{
	/// <summary>
	/// Creates a custom <see cref="IEqualityComparer{T}"/> for a <see cref="ValueTuple{T1, T2}"/>
	...
	/// <param name="comparer1">The custom comparer for <typeparamref name="T1"/>. If <see langword="null"/>, then <see cref="EqualityComparer{T}.Default" /> will be used.</param>
	/// <param name="comparer2">The custom comparer for <typeparamref name="T2"/>. If <see langword="null"/>, then <see cref="EqualityComparer{T}.Default" /> will be used.</param>
	/// <returns>An <see cref="IEqualityComparer{T}"/> that can be used to compare two <see cref="ValueTuple{T1, T2}"/> using the provided comparers for each component.</returns>
