...
public static partial class SuperEnumerable
{
	...
	/// </para>
	/// </remarks>
	public static IEnumerable<(TLeft Left, TRight Right)> InnerLoopJoin<TLeft, TRight, TKey>(
	...
	/// </para>
	/// </remarks>
	public static IEnumerable<TResult> InnerLoopJoin<TLeft, TRight, TKey, TResult>(
		this IEnumerable<TLeft> left,
		IEnumerable<TRight> right,
		Func<TLeft, TKey> leftKeySelector,
		Func<TRight, TKey> rightKeySelector,
	...
	/// </para>
	/// </remarks>
	public static IEnumerable<(TLeft Left, TRight? Right)> LeftOuterLoopJoin<TLeft, TRight, TKey>(
		this IEnumerable<TLeft> left,
		IEnumerable<TRight> right,
		Func<TLeft, TKey> leftKeySelector,
		Func<TRight, TKey> rightKeySelector,
	...
	/// </para>
	/// </remarks>
	public static IEnumerable<TResult> LeftOuterLoopJoin<TLeft, TRight, TKey, TResult>(
		this IEnumerable<TLeft> left,
		IEnumerable<TRight> right,
		Func<TLeft, TKey> leftKeySelector,
		Func<TRight, TKey> rightKeySelector,
