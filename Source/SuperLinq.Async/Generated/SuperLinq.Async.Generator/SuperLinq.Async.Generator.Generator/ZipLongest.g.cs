...
public static partial class AsyncSuperEnumerable
{
	...
	public static global::System.Collections.Generic.IAsyncEnumerable<TResult> ZipLongest<T1, T2, TResult>(this 
		global::System.Collections.Generic.IAsyncEnumerable<T1> first,
		global::System.Collections.Generic.IAsyncEnumerable<T2> second,
	...
	)
	{
		...
		)
		{
			...
			while (true)
			{
				var v1 = (f1 && (f1 = await e1.MoveNextAsync()))
					? e1.Current : default(T1);
				var v2 = (f2 && (f2 = await e2.MoveNextAsync()))
					? e2.Current : default(T2);
	...
	/// <typeparam name="T2">The type of the elements of <paramref name="second" />.</typeparam>
	/// <param name="second">The second sequence of elements.</param>
	public static global::System.Collections.Generic.IAsyncEnumerable<(T1?,T2?)> 
	...
	public static global::System.Collections.Generic.IAsyncEnumerable<TResult> ZipLongest<T1, T2, T3, TResult>(this 
		global::System.Collections.Generic.IAsyncEnumerable<T1> first,
		global::System.Collections.Generic.IAsyncEnumerable<T2> second,
		global::System.Collections.Generic.IAsyncEnumerable<T3> third,
	...
	)
	{
		...
		)
		{
			...
			while (true)
			{
				...
				var v2 = (f2 && (f2 = await e2.MoveNextAsync()))
					? e2.Current : default(T2);
				var v3 = (f3 && (f3 = await e3.MoveNextAsync()))
					? e3.Current : default(T3);
	...
	/// <typeparam name="T3">The type of the elements of <paramref name="third" />.</typeparam>
	/// <param name="third">The third sequence of elements.</param>
	public static global::System.Collections.Generic.IAsyncEnumerable<(T1?,T2?,T3?)> 
	...
	public static global::System.Collections.Generic.IAsyncEnumerable<TResult> ZipLongest<T1, T2, T3, T4, TResult>(this 
		global::System.Collections.Generic.IAsyncEnumerable<T1> first,
		global::System.Collections.Generic.IAsyncEnumerable<T2> second,
		global::System.Collections.Generic.IAsyncEnumerable<T3> third,
		global::System.Collections.Generic.IAsyncEnumerable<T4> fourth,
	...
	)
	{
		...
		)
		{
			...
			while (true)
			{
				...
				var v3 = (f3 && (f3 = await e3.MoveNextAsync()))
					? e3.Current : default(T3);
				var v4 = (f4 && (f4 = await e4.MoveNextAsync()))
					? e4.Current : default(T4);
	...
	/// <typeparam name="T4">The type of the elements of <paramref name="fourth" />.</typeparam>
	/// <param name="fourth">The fourth sequence of elements.</param>
	public static global::System.Collections.Generic.IAsyncEnumerable<(T1?,T2?,T3?,T4?)> 
