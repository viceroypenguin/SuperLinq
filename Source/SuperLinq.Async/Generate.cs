...
public static partial class AsyncSuperEnumerable
{
	...
	public static IAsyncEnumerable<TResult> Generate<TResult>(TResult initial, Func<TResult, ValueTask<TResult>> generator)
	{
		...
		static async IAsyncEnumerable<TResult> _(TResult current, Func<TResult, ValueTask<TResult>> generator, [EnumeratorCancellation] CancellationToken cancellationToken = default)
		{
			while (true)
			{
